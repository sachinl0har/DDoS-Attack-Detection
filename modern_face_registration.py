...
label = customtkinter.CTkLabel(frame, text ="Register")
label.pack(pady =20, padx = 5)

fullname = customtkinter.CTkLabel(frame,text="Fullname: ")
fullname.place(x =90, y=150)

address= customtkinter.CTkLabel(frame,text="Address: ")
address.place(x =90, y=210)

email = customtkinter.CTkLabel(frame,text="Email: ")
email.place(x =90, y=270)

phone= customtkinter.CTkLabel(frame,text="Phone: ")
phone.place(x =90, y=330)

age= customtkinter.CTkLabel(frame,text="Age: ")
age.place(x =90, y=390)

gender= customtkinter.CTkLabel(frame,text="Gender: ")
gender.place(x =90, y=450)

username = customtkinter.CTkLabel(frame,text="Username: ")
username.place(x =90, y=510)

password= customtkinter.CTkLabel(frame,text="Password: ")
password.place(x =90, y=570)

confirm_password= customtkinter.CTkLabel(frame,text="F.Password: ")
...
entry4 = customtkinter.CTkEntry(app,textvariable=Phone, width =150)
...
button1 = customtkinter.CTkButton(app, text="Register", command = insert)
button1.place(x =70, y=690)

button1 = customtkinter.CTkButton(app, text="Login", command = login)
